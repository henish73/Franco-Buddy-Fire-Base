...
const courses = [
  { id: "a1-a2-beginner", title: "A1-A2 Beginner", description: "Start your French journey here. Build a strong foundation.", duration: "12 Weeks", image: "https://placehold.co/600x400.png", dataAiHint: "students learning class" },
  { id: "b1-b2-intermediate", title: "B1-B2 Intermediate", description: "Enhance your fluency and conversational skills for real-world scenarios.", duration: "16 Weeks", image: "https://placehold.co/600x400.png", dataAiHint: "conversation discussion group" },
  { id: "c1-c2-advanced", title: "C1-C2 Advanced", description: "Perfect your French to a near-native level for professional use.", duration: "20 Weeks", image: "https://placehold.co/600x400.png", dataAiHint: "professional presentation" },
  { id: "tef-canada-prep", title: "TEF Canada Test Prep", description: "Specialized, intensive preparation to ace the TEF exam.", duration: "8 Weeks", image: "https://placehold.co/600x400.png", dataAiHint: "exam study focus" },
];

const testimonials = [
  { quote: "FRANCOBUDDY was a game-changer! I scored 371/400 in my TEF exam, which was crucial for my PR application. The instructors are simply the best.", author: "Priya Sharma", role: "Software Engineer", location: "Toronto, ON", image: "https://placehold.co/100x100.png", dataAiHint: "professional woman portrait", rating: 5 },
  { quote: "I went from zero French (A0) to a confident B2 level, which helped me secure a promotion and an $18k salary increase. The personalized approach made all the difference.", author: "Rahul Patel", role: "Business Analyst", location: "Mississauga, ON", image: "https://placehold.co/100x100.png", dataAiHint: "professional man portrait", rating: 5 },
  { quote: "As a university student, I needed to pass my DELF B2 exam. FRANCOBUDDY's flexible schedule and supportive community were perfect for me. I passed with flying colors!", author: "Kavya Reddy", role: "University Student", location: "Brampton, ON", image: "https://placehold.co/100x100.png", dataAiHint: "female student portrait", rating: 4.8 },
];
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {courses.map((course) => (
              <Card key={course.id} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col bg-card">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="shadow-lg flex flex-col p-6 bg-card">
