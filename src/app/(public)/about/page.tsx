...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 bg-card p-8 md:p-12 rounded-lg shadow-xl max-w-4xl mx-auto">
            <Image
              ...
              alt="Henish Patel, Founder of FrancoBuddy"
              width={250}
              height={250}
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-foreground/80 mb-3">
                &quot;Bonjour! I&apos;m Henish, a passionate Computer Science student at Algoma University in Brampton, with a deep interest in Artificial Intelligence. My journey into founding FrancoBuddy stems from a desire to merge quality education with technology to solve real-world challenges.&quot;
              </p>
              <p className="text-foreground/80 mb-3">
                &quot;Seeing fellow students and newcomers struggle with TEF Canada preparation inspired me to create a platform that offers not just expert French coaching, but also the flexibility and personalized support that modern learners need. My vision is to make FrancoBuddy the most trusted and effective resource for anyone aiming to prove their French proficiency for their Canadian dreams.&quot;
              </p>
      ...
      {/* Why Choose FrancoBuddy? Section (Summarized) */}
      <section className="py-16 md:py-24 bg-primary/5">
        <div className="container mx-auto px-4">
          <SectionTitle title="Why Choose FrancoBuddy?" subtitle="The distinct advantages that set us apart." />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center bg-card p-8 md:p-12 rounded-lg shadow-xl">
            ...
            <p className="text-foreground/80 mb-4">
              While we proudly serve students across Canada online, FrancoBuddy is rooted in the vibrant community of Brampton, Ontario. We understand the specific needs of international students and newcomers in the Greater Toronto Area and strive to be a supportive local resource.
            </p>
            <p className="text-foreground/80">
