          ...
          <p className="text-lg md:text-xl text-secondary-foreground/80 max-w-3xl mx-auto">
           ...
           <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Button asChild variant="default" size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90">
               ...
               <Button asChild variant="outline" size="lg" className="bg-secondary-foreground text-secondary hover:bg-secondary-foreground/90">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-8">
              <Card className="shadow-lg">
                <CardHeader>
                  <CardTitle className="text-xl text-secondary">Direct Contact</CardTitle>
                </CardHeader>
              ...
              <Card className="shadow-lg">
                <CardHeader>
                  <CardTitle className="text-xl text-secondary">Business Hours</CardTitle>
                </CardHeader>
                <CardContent>
